        ...
        >
          ...
          <div className="rounded-lg p-6 text-center shadow-md" style={{ backgroundColor: '#ffffff' }}>
            ...
            <p className="text-sm" style={{ color: '#6b6b6b' }}>
              Please respond by{' '}
              <span className="font-semibold" style={{ color: '#8b7355' }}>December 14, 2025</span>
            </p>
          </div>
          ...
          <div className="rounded-lg p-6 text-center shadow-md" style={{ backgroundColor: '#ffffff' }}>
            ...
            <h3 className="font-semibold mb-2" style={{ color: '#2c2c2c', fontFamily: "'Cormorant Garamond', serif", fontSize: '1.3rem' }}>One Code Per Person</h3>
            <p className="text-sm" style={{ color: '#6b6b6b' }}>
              Your Code Invitation Is Unique to You
            </p>
          </div>
          ...
          <div className="rounded-lg p-6 text-center shadow-md" style={{ backgroundColor: '#ffffff' }}>
            ...
            <h3 className="font-semibold mb-2" style={{ color: '#2c2c2c', fontFamily: "'Cormorant Garamond', serif", fontSize: '1.3rem' }}>When Attending?</h3>
            <p className="text-sm" style={{ color: '#6b6b6b' }}>
